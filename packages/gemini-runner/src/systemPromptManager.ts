...
export class SystemPromptManager {
	...
	constructor(agithaHome: string, workspaceName: string) {
		this.agithaHome = agithaHome;
		// Use workspace-specific path to support parallel execution
		// Format: ~/.agitha/gemini-system-prompts/<workspace-name>.md
		// NOTE: Workspace-name is the Linear issue identifier
		const promptsDir = join(this.agithaHome, "gemini-system-prompts");
