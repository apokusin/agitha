...
import type { McpServerConfig } from "agitha-core";
...
/**
 * Convert McpServerConfig (agitha-core format) to GeminiMcpServerConfig (Gemini CLI format)
 ...
 * @param config - McpServerConfig from agitha-core
