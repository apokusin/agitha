...
import type { SDKSystemMessage } from "agitha-claude-runner";
import type {
	SDKAssistantMessage,
	SDKMessage,
	SDKResultMessage,
...
/**
 * Convert a Gemini stream event to agitha-core SDKMessage format
 *
 * This adapter maps Gemini CLI's streaming events to the agitha-core SDKMessage
...
/**
 * Create a Agitha Core SDK UserMessage from a plain string prompt
 *
