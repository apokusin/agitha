 ...
 * - 'proxy': Use AGITHA_API_KEY Bearer token for authentication (self-hosted via CYHOST)
...
export interface GitLabEventTransportConfig {
	...
	/** Secret for verification (AGITHA_API_KEY for proxy, GITLAB_WEBHOOK_SECRET for signature) */
	secret: string;
