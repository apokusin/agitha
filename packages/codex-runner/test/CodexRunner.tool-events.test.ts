import type { SDKAssistantMessage, SDKUserMessage } from "agitha-core";
...
describe("CodexRunner tool event mapping", () => {
	...
	it("maps file_change events to Edit tool entries with normalized paths", () => {
		const runner = createRunner("/Users/connor/code/agitha");
		...
		handleEvent(runner, {
			...
			item: {
				...
				changes: [
					{
						path: "/Users/connor/code/agitha/packages/codex-runner/src/CodexRunner.ts",
						kind: "update",
					},
				],
				status: "completed",
