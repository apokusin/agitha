...
import { SimpleCodexRunner } from "agitha-codex-runner";
import { SimpleCursorRunner } from "agitha-cursor-runner";
import { SimpleGeminiRunner } from "agitha-gemini-runner";
...
async function testRunner(name, RunnerClass, model) {
	...
	try {
		const runner = new RunnerClass({
			...
			agithaHome: path.join(os.homedir(), ".agitha"),
