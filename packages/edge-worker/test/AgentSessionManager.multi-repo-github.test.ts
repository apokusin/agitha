...
describe("AgentSessionManager - Multi-repo GitHub @ mention routing", () => {
	...
	const multiRepoWorkspace = {
		path: "/home/agitha/.agitha/worktrees/CYPACK-920",
		isGitWorktree: true,
		repoPaths: {
			"repo-a-id": "/home/agitha/.agitha/worktrees/CYPACK-920/frontend-app",
			"repo-b-id": "/home/agitha/.agitha/worktrees/CYPACK-920/backend-api",
		},
	};
	...
	it("should resolve the correct sub-worktree path from workspace.repoPaths", () => {
		...
		expect(session!.workspace.repoPaths?.["repo-b-id"]).toBe(
			"/home/agitha/.agitha/worktrees/CYPACK-920/backend-api",
		);
	});
