...
const _base = mkdtempSync(join(tmpdir(), "agitha-edge-worker-"));
 ...
 */
export const TEST_AGITHA_HOME = join(_base, "agitha-home");
export const TEST_AGITHA_CHAT = join(_base, "chat");
export const TEST_WORKING_DIR = join(_base, "workspace");

// Deploy bundled skills to TEST_AGITHA_HOME so SkillsPluginResolver can discover them.
...
const deployedPluginPath = join(TEST_AGITHA_HOME, "agitha-skills-plugin");
