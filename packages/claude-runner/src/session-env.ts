...
/**
 * Agitha-specific env vars injected into every Claude Code subprocess.
 ...
 */
export const AGITHA_SESSION_ENV = {
 ...
 * itself, so we must do it here. Then applies the shared Agitha session flags
