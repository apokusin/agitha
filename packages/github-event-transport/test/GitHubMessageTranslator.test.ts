import type { GitHubSessionStartPlatformData } from "agitha-core";
...
describe("GitHubMessageTranslator", () => {
	...
	const createMockIssueCommentPayload = (
		...
		comment: {
			id: 456,
			body: "@agitha please review this PR",
	...
	describe("translate - issue_comment", () => {
		it("should translate issue_comment event to SessionStartMessage", () => {
			...
			expect(sessionStart.initialPrompt).toBe("@agitha please review this PR");
			...
			expect(platformData.comment.body).toBe("@agitha please review this PR");
	...
	describe("translateAsUserPrompt", () => {
		it("should translate issue_comment as UserPromptMessage", () => {
			...
			expect(userPrompt.content).toBe("@agitha please review this PR");
