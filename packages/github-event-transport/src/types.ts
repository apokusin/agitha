 ...
 * - 'proxy': Use AGITHA_API_KEY Bearer token for authentication (self-hosted)
...
export interface GitHubEventTransportConfig {
	...
	/** Secret for verification (AGITHA_API_KEY for proxy, GITHUB_WEBHOOK_SECRET for signature) */
	secret: string;
