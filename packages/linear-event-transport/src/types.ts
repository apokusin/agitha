...
import type { AgentEvent, InternalMessage } from "agitha-core";
import type { FastifyInstance } from "fastify";

/**
 * Verification mode for Linear webhooks
 * - 'direct': Use LINEAR_WEBHOOK_SECRET for Linear signature verification
 * - 'proxy': Use AGITHA_API_KEY Bearer token for proxy authentication
 */
...
export interface LinearEventTransportConfig {
	...
	/** Secret for verification (LINEAR_WEBHOOK_SECRET or AGITHA_API_KEY) */
	secret: string;
