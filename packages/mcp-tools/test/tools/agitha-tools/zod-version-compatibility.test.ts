...
describe("CYPACK-478: Zod v3 vs v4 peer dependency mismatch", () => {
	...
	it("should create agitha-tools server successfully (but fail at runtime)", () => {
	...
	it("should demonstrate Zod v4 API is different from v3", () => {
		// Create a schema like those in agitha-tools
	...
	it("should fail: version mismatch breaks tool invocation", () => {
		...
		//
		// Expected behavior:
		// 1. Claude calls mcp__agitha-tools__linear_agent_session_create({ issueId: "TEST-123" })
