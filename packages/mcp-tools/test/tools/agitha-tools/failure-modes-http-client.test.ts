...
import { createFetchFailureModesClient } from "../../../src/tools/agitha-tools/failure-modes-http-client.js";
...
describe("createFetchFailureModesClient", () => {
	it("sends Bearer token + JSON body to /api/failure-modes", async () => {
		...
		const client = createFetchFailureModesClient({
			baseUrl: "https://app.atagitha.com/",
			apiKey: "secret-key",
		...
		expect(url).toBe("https://app.atagitha.com/api/failure-modes");
