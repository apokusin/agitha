// Translates the Agitha / Claude `SandboxSettings` shape into the Cursor SDK's
 ...
 * agitha-claude-runner — the EdgeWorker is the only consumer that originates
...
export function buildCursorSandboxJson(
	...
	// When the Agitha egress proxy is in use, child shell processes need to be
