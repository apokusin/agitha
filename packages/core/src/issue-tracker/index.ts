 ...
 * It decouples the Agitha codebase from Linear-specific implementations, enabling
 ...
 * Basic usage:
 * ```typescript
 * import { IIssueTrackerService, Issue, Comment } from '@agitha/core/issue-tracker';
 *
 ...
 *   isNewCommentEvent
 * } from '@agitha/core/issue-tracker';
 *
