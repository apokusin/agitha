...
describe("Logger", () => {
	...
	afterEach(() => {
		vi.restoreAllMocks();
		delete process.env.AGITHA_LOG_LEVEL;
	});
	...
	describe("AGITHA_LOG_LEVEL environment variable", () => {
		it("respects AGITHA_LOG_LEVEL=DEBUG", () => {
			process.env.AGITHA_LOG_LEVEL = "DEBUG";
			const logger = createLogger({ component: "Test" });
		...
		it("respects AGITHA_LOG_LEVEL=WARN", () => {
			process.env.AGITHA_LOG_LEVEL = "WARN";
			const logger = createLogger({ component: "Test" });
		...
		it("falls back to INFO for unrecognized values", () => {
			process.env.AGITHA_LOG_LEVEL = "FOOBAR";
			const logger = createLogger({ component: "Test" });
			logger.debug("filtered");
			logger.info("visible");
