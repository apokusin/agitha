---
name: release
description: Run a Agitha release by publishing all packages to npm in the correct dependency order, updating changelogs, and creating git tags.
---

# Release

Publish Agitha packages to npm and create a release.
...
1. **Update CHANGELOG.md and CHANGELOG.internal.md**:
   ...
   - CHANGELOG.md: Focus on end-user impact from the perspective of the `agitha` CLI
