---
name: f1-test-drive
description: Orchestrate F1 test drives to validate the Agitha agent system end-to-end. Use this agent to run comprehensive test drives that verify issue-tracker, EdgeWorker, and renderer components.
