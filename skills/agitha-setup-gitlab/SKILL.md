---
name: agitha-setup-gitlab
description: Configure GitLab authentication for Agitha — glab CLI login and git config for creating merge requests.
---
...
Configures GitLab CLI and git so Agitha can create branches, commits, and merge requests.
