---
name: agitha-setup-prerequisites
description: Check and install prerequisites for Agitha — Node.js, jq, gh CLI, and the agitha-ai npm package.
---
...
Checks system prerequisites and installs `agitha-ai`.
...
# pnpm
pnpm install -g agitha-ai

# bun
bun install -g agitha-ai

# yarn
yarn global add agitha-ai
```
...
## Step 5: Ensure ~/.agitha directory exists

```bash
mkdir -p ~/.agitha
```

If `~/.agitha/.env` already exists, note it and inform the user that existing values will be preserved.
