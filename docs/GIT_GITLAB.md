...
Agitha uses your local Git and GitLab CLI (`glab`) authentication to create commits and merge requests. This guide explains how to configure these tools and what permissions Agitha will have.

---

## Understanding Permissions

**Important:** Agitha operates with the same permissions as your authenticated Git and GitLab CLI user.

When Agitha creates commits and MRs:
...
- **Audit commits** - Agitha-authored MRs include a `<!-- generated-by-agitha -->` marker for traceability
