...
**Command**: `AGITHA_PORT=3600 AGITHA_REPO_PATH=/tmp/f1-test-drive-003 bun run server.ts`
...
2. **All Tools Enabled** (F1 server.ts)
   ...
   - Dependency: Added `agitha-claude-runner` to F1 package.json
...
- `apps/f1/package.json`: Added `agitha-claude-runner` dependency
