...
**Test Repo**: /Users/agentops/.agitha/worktrees/CYPACK-711
**Server Port**: 30111
...
> "use the f1 test driver to test your implementation, with an 'orchestrator' label. You'll need to enable a Agitha 'edgeconfig' that has multiple repositories to see whether it can handle it."
...
2. **F1 server.ts**: Multi-repo mode support
   - Environment variable: `AGITHA_REPO_PATH_2`
...
### 1. Build Project
```bash
cd /Users/agentops/.agitha/worktrees/CYPACK-711
pnpm build
```
...
```bash
cd /Users/agentops/.agitha/worktrees/CYPACK-711/apps/f1
AGITHA_PORT=30111 \
AGITHA_REPO_PATH=/Users/agentops/.agitha/worktrees/CYPACK-711 \
AGITHA_REPO_PATH_2=/Users/agentops/.agitha/worktrees/CYPACK-711 \
node dist/server.js
```
...
✓ Server started successfully
  ...
  Platform:  cli
  Agitha Home: /var/folders/.../agitha-f1-1768338654921
  Repository: /Users/agentops/.agitha/worktrees/CYPACK-711
  Multi-Repo: enabled (/Users/agentops/.agitha/worktrees/CYPACK-711)
...
```bash
cd /Users/agentops/.agitha/worktrees/CYPACK-711/apps/f1
AGITHA_PORT=30111 ./f1 create-issue \
...
```bash
AGITHA_PORT=30111 ./f1 assign-issue --issue-id issue-2 --assignee-id user-default
```
...
```bash
AGITHA_PORT=30111 ./f1 start-session --issue-id issue-2
```
...
3. **Document F1 multi-repo mode**:
   - Add example to `apps/f1/README.md` showing how to use `AGITHA_REPO_PATH_2`
...
**Logs Preserved**: /var/folders/.../agitha-f1-1768338654921/logs/DEF-2/
